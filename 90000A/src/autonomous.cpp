...
/*
    quickTurnTo(-60, 100);
    quickTurnTo(12, 100);
    intake.spin(forward, motorVoltage * 100, vex::voltageUnits::mV);
    quickMoveDistance(46, 100, 1300, 20000);
    wait(1000, msec);
    quickMoveDistance(-50, 100, 1300, 20000);
    quickTurnTo(90, 100);
    intake.spin(forward, - motorVoltage * 100, vex::voltageUnits::mV);
    quickMoveDistance(32, 100, 1300, 20000);    
    quickMoveDistance(-40, 100, 1800, 20000);
    quickTurnTo(160, 100);
...
/*
    ...
    while(true) 
    {        
        if (autoTimer.getTime() > 29000 ) {   //28000
    ...
    quickTurnTo(90, 100);
    Brain.Screen.print("IMUHeading: %.1f \n", IMUHeading());
    quickMoveDistance(-95, 100, 2100, 20000);
    quickTurnTo(25, 100);
    openWings();
    quickMoveDistance(-30, 50, 1500);
    closeWings();
    ...
    // third stage
    quickMoveDistance(4, 100, 300);
    closeWings();
    quickTurnTo(180, 100);
    quickMoveDistance(55, 100, 1200, 20000);
    
    quickTurnTo(150, 100);
    quickMoveDistance(-50, 100, 1000);
 ...
 */
    ...
    intakeTriball(100);
    quickMoveDistance(5, 100, 500);
    quickMoveDistance(-34, 100, 1300);
    quickTurnTo(-30,100);
    openWings();
    quickMoveDistance(-24, 100, 800);
    quickTurnTo(-80, 100);
